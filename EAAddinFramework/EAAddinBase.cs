...
//        private string[] _menuOptions = {"&MenuOption1","&MenuOption2","&MenuOption3"};       
        ...
        /// <returns></returns>
        public virtual object EA_GetMenuItems(EA.Repository Repository, string Location, string MenuName)
        {
        ...
        public virtual void EA_GetMenuState(EA.Repository Repository, string Location, string MenuName, string ItemName, ref bool IsEnabled, ref bool IsChecked)
        {
        ...
        public virtual void EA_MenuClick(EA.Repository Repository, string Location, string MenuName, string ItemName){}
    
        /// <summary>
        /// EA calls this operation when it exists. 
        /// Can be used to do some cleanup work.
        /// </summary>
