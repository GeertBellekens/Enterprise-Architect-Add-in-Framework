...
{
	/// <summary>
	/// Description of MySQLForeignKeyTransformer.
	/// </summary>
	public class MySQLForeignKeyTransformer:EAForeignKeyTransformer
	{
		
		public MySQLForeignKeyTransformer(ForeignKey foreignKey, UTF_EA.AssociationEnd associationEnd,NameTranslator nameTranslator):base(foreignKey,associationEnd,nameTranslator)
		{
		}
		public MySQLForeignKeyTransformer(Table table,List<Column> FKInvolvedColumns,MySQLTableTransformer dependingTransformer,UTF_EA.AssociationEnd associationEnd, NameTranslator nameTranslator):base(nameTranslator)
		{
