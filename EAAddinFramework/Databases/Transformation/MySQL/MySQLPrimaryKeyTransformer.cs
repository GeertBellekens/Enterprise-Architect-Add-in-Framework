...
{
	/// <summary>
	/// Description of MySQLPrimaryKeyTransformer.
	/// </summary>
	public class MySQLPrimaryKeyTransformer:EAPrimaryKeyTransformer
	{
		public MySQLPrimaryKeyTransformer(Table table, List<Column> involvedColumns,NameTranslator nameTranslator):base(table,nameTranslator)
		{
