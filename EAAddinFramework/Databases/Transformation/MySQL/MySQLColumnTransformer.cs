...
{
	/// <summary>
	/// Description of MySQLColumnTransformer.
	/// </summary>
	public class MySQLColumnTransformer:EAColumnTransformer
	{
		...
		public MySQLColumnTransformer(Table table,NameTranslator nameTranslator):base(table,nameTranslator){}
		public MySQLColumnTransformer(Table table, Column column, UTF_EA.Attribute attribute,NameTranslator nameTranslator):this(table,nameTranslator)
		{
			this.logicalProperty = attribute;
			this.column = column;
		}
		public MySQLColumnTransformer(Table table, Column involvedColumn,MySQLTableTransformer dependingTransformer,UTF_EA.AssociationEnd associationEnd,NameTranslator nameTranslator):this(table,nameTranslator)
		{
