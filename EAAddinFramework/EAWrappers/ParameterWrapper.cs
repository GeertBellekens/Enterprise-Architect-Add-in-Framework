...
namespace TSF.UmlToolingFramework.Wrappers.EA
{
    public class ParameterWrapper : Parameter
    {
        ...
        {
            get => ParameterDirectionKind.getUMLParameterDirectionkind(this.wrappedParameter.Kind);
            set => this.wrappedParameter.Kind = ParameterDirectionKind.getEAParameterDirectionKind(value);
        }
