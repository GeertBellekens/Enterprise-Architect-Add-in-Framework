...
namespace TSF.UmlToolingFramework.Wrappers.EA
{
    public class Association : ConnectorWrapper, UML.Classes.Kernel.Association
    {
        ...
        {
            get => new HashSet<UML.Classes.Kernel.Element>(this.memberEnds.Cast<UML.Classes.Kernel.Element>());
            set => this.memberEnds = value.Cast<UML.Classes.Kernel.Property>().ToList();
        }
